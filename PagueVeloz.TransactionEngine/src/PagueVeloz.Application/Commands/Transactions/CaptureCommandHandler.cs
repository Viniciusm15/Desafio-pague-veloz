...
public class CaptureCommandHandler : IRequestHandler<CaptureCommand, TransactionResponse>
{
    ...
    public CaptureCommandHandler(IAccountRepository accountRepository, IUnitOfWork unitOfWork)
    {
        _accountRepository = accountRepository;
        _unitOfWork = unitOfWork;
    }

    public async Task<TransactionResponse> Handle(CaptureCommand request, CancellationToken cancellationToken)
    {
