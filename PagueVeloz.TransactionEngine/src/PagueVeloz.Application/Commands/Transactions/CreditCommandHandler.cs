...
public class CreditCommandHandler : IRequestHandler<CreditCommand, TransactionResponse>
{
    ...
    public CreditCommandHandler(IAccountRepository accountRepository, IUnitOfWork unitOfWork)
    {
        _accountRepository = accountRepository;
        _unitOfWork = unitOfWork;
    }

    public async Task<TransactionResponse> Handle(CreditCommand request, CancellationToken cancellationToken)
    {
